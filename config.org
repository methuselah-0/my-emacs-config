...
If you are on guix, you might need to install =gcc-objc++= to make the
...
PYDEVD_DISABLE_FILE_VALIDATION=1 LD_LIBRARY_PATH=~/.guix-profile/lib /home/user1/.pyenv/versions/jupyter_only/bin/jupyter "$@"
#+end_src
