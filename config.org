...
(global-set-key (kbd "H-s-a") 'windmove-left)
(global-set-key (kbd "H-s-d") 'windmove-right)
(global-set-key (kbd "H-s-w") 'windmove-up)
(global-set-key (kbd "H-s-s") 'windmove-down)
#+end_src
