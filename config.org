...
(global-set-key (kbd "H-s-b") 'windmove-left)
(global-set-key (kbd "H-s-m") 'windmove-right)
(global-set-key (kbd "H-s-h") 'windmove-up)(
global-set-key (kbd "H-s-n") 'windmove-down)
#+end_src
